...
export default function AdminOrderNotifications({
  ...
  return (
    <div className="mt-5 flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-black/10 bg-[#F8F6F1] p-4">
      ...
      <div className="flex flex-wrap gap-2">
        {count > 0 && (
          ...
          >
            View new orders{" "}
            <span className="ml-2 rounded-full bg-[#b66b4d] px-2 py-0.5">
              {count}
            </span>
          </button>
        )}
